...
exports.PayoutsModule = PayoutsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [payouts_service_1.PayoutsService, payouts_repository_1.PayoutsRepository],
        exports: [payouts_service_1.PayoutsService, payouts_repository_1.PayoutsRepository],
    })
], PayoutsModule);
